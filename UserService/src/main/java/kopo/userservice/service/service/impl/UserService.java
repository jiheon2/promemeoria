...
import kopo.userservice.repository.repository.UserRepository;
import kopo.userservice.repository.repository.entity.UserEntity;
import kopo.userservice.service.service.UserInterface;
...
//
//        try {
//            Optional<UserEntity> userEntity = userRepository.findByUserNameAndUserEmail(userId, userEmail);
//
...
//
//                return MsgDTO.builder()
//                        .msg("회원님의 ID는 " + password + "입니다. 변경해주시길 바랍니다.")
//                        .result(Result.SUCCESS.getCode())
//                        .build();
//            } else {
//                return MsgDTO.builder()
